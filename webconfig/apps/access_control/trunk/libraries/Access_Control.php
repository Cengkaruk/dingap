 ...
 * @link       http://www.clearfoundation.com/docs/developer/apps/access_control/
 */
...
namespace clearos\apps\access_control;
...
clearos_load_language('access_control');
...
class Access_Control extends Engine
{
    ...
    // Files and paths
    const FILE_CONFIG = '/etc/clearos/access_control.conf';
    const FILE_CUSTOM = '/var/clearos/access_control/custom/access_control';
    const PATH_CUSTOM = '/var/clearos/access_control/custom';
    const PATH_PUBLIC = '/var/clearos/access_control/public';
    const PATH_AUTHENTICATED = '/var/clearos/access_control/authenticated';
