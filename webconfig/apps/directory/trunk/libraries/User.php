...
use \clearos\apps\directory\drivers\User_OpenLDAP as User_OpenLDAP;

clearos_load_library('base/Engine');
clearos_load_library('directory/drivers/User_OpenLDAP');
...
class User extends Engine
{
    ...
    public static function create($username)
    {
        ...
        $class = '\clearos\apps\directory\drivers\User_' . $driver;
