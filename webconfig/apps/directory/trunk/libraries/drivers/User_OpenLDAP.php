...
use \clearos\apps\directory\User as User;
...
clearos_load_library('directory/User');
...
use \clearos\apps\directory\User_Already_Exists_Exception as User_Already_Exists_Exception;
use \clearos\apps\directory\User_Not_Found_Exception as User_Not_Found_Exception;

clearos_load_library('base/Engine_Exception');
clearos_load_library('base/Validation_Exception');
clearos_load_library('directory/User_Already_Exists_Exception');
clearos_load_library('directory/User_Not_Found_Exception');
...
class User_OpenLDAP extends Engine
{
    ///////////////////////////////////////////////////////////////////////////////
    // C O N S T A N T S
    ///////////////////////////////////////////////////////////////////////////////
...
print_r($ldap_object);
    ...
    public function get_info()
    {
        ...
        $info['core'] = OpenLDAP_Utilities::convert_attributes_to_array($attributes, $this->info_map);
