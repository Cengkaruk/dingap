...
echo form_open('web_access_control/add');
...
echo field_multiselect_dropdown('ident_user', $user_options, $ident, lang('web_access_control_apply_user'), FALSE, array('id' => 'byuser'));
