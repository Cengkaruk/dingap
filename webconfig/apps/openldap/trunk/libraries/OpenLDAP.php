...
use \clearos\apps\openldap\OpenLDAP_Unavailable_Exception as OpenLDAP_Unavailable_Exception;

clearos_load_library('base/Engine_Exception');
clearos_load_library('base/Validation_Exception');
clearos_load_library('openldap/OpenLDAP_Unavailable_Exception');
