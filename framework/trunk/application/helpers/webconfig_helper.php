...
// require_once(ClearOsEnvironment::$framework_path . '/application/libraries/Webconfig.php');
...
{
	if (isset($_SESSION['system_template']) && file_exists(ClearOsEnvironment::$htdocs_path . "/templates/" . $_SESSION['system_template'] . "/images/icons/16x16/$icon"))
...
function WebButton($name, $text, $image, $options = null)
{
	...
	if (file_exists(ClearOsEnvironment::$htdocs_path . "/templates/" . $_SESSION['system_template'] . "/widgets/button.inc")) {
		include(ClearOsEnvironment::$htdocs_path . "/templates/" . $_SESSION['system_template'] . "/widgets/button.inc");
		return $button;
	} else if (file_exists(ClearOsEnvironment::$htdocs_path . "/templates/" . $_SESSION['system_template'] . "/html/button.inc")) {
		include(ClearOsEnvironment::$htdocs_path . "/templates/" . $_SESSION['system_template'] . "/html/button.inc");
		return $button;
	} else {
...
{
	require(ClearOsEnvironment::$htdocs_path . "/templates/" . $_SESSION['system_template'] . "/widgets/tabs.inc");
}
...
function WebDialogIntro($title, $icon, $summary)
{
	...
	$large_icon_override = ClearOsEnvironment::$htdocs_path . "/templates/" . $_SESSION['system_template'] . "/images/icons/32x32/" . $large_icon;
	$small_icon_override = ClearOsEnvironment::$htdocs_path . "/templates/" . $_SESSION['system_template'] . "/images/icons/16x16/" . $small_icon;
	...
	require(ClearOsEnvironment::$htdocs_path . "/templates/" . $_SESSION['system_template'] . "/widgets/summary.inc");
...
function WebDialogBox($class, $title, $icon, $blurb)
{
	...
	require(ClearOsEnvironment::$htdocs_path . "/templates/" . $_SESSION['system_template'] . "/widgets/dialog.inc");
}
...
{
	require(ClearOsEnvironment::$htdocs_path . "/templates/" . $_SESSION['system_template'] . "/widgets/chartlegend.inc");
...
{
	require(ClearOsEnvironment::$htdocs_path . "/templates/" . $_SESSION['system_template'] . "/widgets/chart.inc");
}
...
";
	...
	if (file_exists(ClearOsEnvironment::$themes_path . '/' . $_SESSION['system_template']. '/widgets/head.inc'))
		require(ClearOsEnvironment::$themes_path . '/' . $_SESSION['system_template']. '/widgets/head.inc');
	...
	if (isset(ClearOsEnvironment::$clearos_devel_versions['app'][$app]))
		$app_version = ClearOsEnvironment::$clearos_devel_versions['app'][$app] . '/';
	...
	if (file_exists(ClearOsEnvironment::$apps_path . '/' . $js_path))
		echo "	<script type='text/javascript' src='/modules" . $js_path . "'></script>\n";

	if (file_exists(ClearOsEnvironment::$apps_path . '/' . $css_path))
...
function WebHeaderLayout($layout)
{
	...
	if (WEBCONFIG_CONSOLE) {
		...
		if (file_exists(ClearOsEnvironment::$themes_path . '/' . $_SESSION['system_template'] . "/widgets/layout_header_default.inc"))
			require(ClearOsEnvironment::$themes_path . '/' . $_SESSION['system_template'] . "/widgets/layout_header_default.inc");
	} else if ($layout == 'splash') {
		if (file_exists(ClearOsEnvironment::$themes_path . '/' . $_SESSION['system_template'] . "/widgets/layout_header_splash.inc"))
			require(ClearOsEnvironment::$themes_path . '/' . $_SESSION['system_template'] . "/widgets/layout_header_splash.inc");
	} else if ($layout == 'wizard') {
		if (file_exists(ClearOsEnvironment::$themes_path . '/' . $_SESSION['system_template'] . "/widgets/layout_header_wizard.inc"))
			require(ClearOsEnvironment::$themes_path . '/' . $_SESSION['system_template'] . "/widgets/layout_header_wizard.inc");
	}
}
...
function WebFooter($layout = 'default', $copyright = '')
{
	...
	if (WEBCONFIG_CONSOLE) {
		...
		if (file_exists(ClearOsEnvironment::$themes_path . '/' . $_SESSION['system_template'] . "/widgets/layout_footer_default.inc"))
			require(ClearOsEnvironment::$themes_path . '/' . $_SESSION['system_template'] . "/widgets/layout_footer_default.inc");
	} else if ($layout == 'splash') {
		if (file_exists(ClearOsEnvironment::$themes_path . '/' . $_SESSION['system_template'] . "/widgets/layout_footer_splash.inc"))
			require(ClearOsEnvironment::$themes_path . '/' . $_SESSION['system_template'] . "/widgets/layout_footer_splash.inc");
	} else if ($layout == 'wizard') {
		if (file_exists(ClearOsEnvironment::$themes_path . '/' . $_SESSION['system_template'] . "/widgets/layout_footer_wizard.inc"))
			require(ClearOsEnvironment::$themes_path . '/' . $_SESSION['system_template'] . "/widgets/layout_footer_wizard.inc");
	}
}
...
function WebAuthenticateDisplayLogin($username, $password, $warning = null)
{
	...
	if (file_exists(ClearOsEnvironment::$htdocs_path . "/themes/" . $_SESSION['system_template'] . "/widgets/login.inc")) {
		require(ClearOsEnvironment::$htdocs_path . "/themes/" . $_SESSION['system_template'] . "/widgets/login.inc");
	} else {
		if (! empty($warning))
...
{
	require(ClearOsEnvironment::$htdocs_path . "/themes/" . $_SESSION['system_template'] . "/widgets/wizard.inc");
}
...
function WebReplacePngTags($png, $alt = "")
{
	...
	if (!file_exists(ClearOsEnvironment::$htdocs_path . "/$png"))
		return "<img src='/images/icon-intro.png' alt='$alt' align='middle' />";

	list($width, $height, $type, $attr) = getimagesize(ClearOsEnvironment::$htdocs_path . "/$png");
