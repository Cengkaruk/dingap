	...
	echo "
	  <script type='text/javascript' language='JavaScript'> " .
	    ...
	    function confirmPurchase(method) {
	      if (method == 1) {
	        $('#sdn-confirm-purchase-content').html('" . WEB_LANG_PURCHASE_CREDIT_CARD . "<div style=\'margin: 15 0 15 0\'><table border=\'0\' width=\'90%\' align=\'center\' style=\'padding:20 0 20 0; background-image: url(/images/icon-clearsdn-logo.png); background-repeat: no-repeat; background-position: 0 0;\'><tr><td align=\'right\' width=\'50%\'>" . CLEARSDN_SERVICE_LANG_USERNAME . ":</td><td width=\'50%\'>" . $details['account'] . "</td></tr>" . (!isset($_SESSION['clearsdn_cookie']['authenticated']) ? "<tr><td align=\'right\'>" . CLEARSDN_SERVICE_LANG_PASSWORD . ":</td><td><input type=\'password\' name=\'password\' id=\'password\' value=\'\'></td></tr>" : "") . "<tr><td align=\'right\'>" . WEB_LANG_CREDIT_CARD . ":</td><td><input type=\'hidden\' name=\'method\' id=\'method\' value=\'' + method + '\'>" . $details['payment']['preauth_card'] . "</td></tr></table></div>');
	      } else {
	        $('#sdn-confirm-purchase-content').html('" . WEB_LANG_PURCHASE_PO . "<div style=\'margin: 15 0 15 0\'><table border=\'0\' width=\'90%\' align=\'center\' style=\'padding:20 0 20 0; background-image: url(/images/icon-clearsdn-logo.png); background-repeat: no-repeat; background-position: 0 0;\'><tr><td align=\'right\' width=\'50%\'>" . CLEARSDN_SERVICE_LANG_USERNAME . ":</td><td width=\'50%\'>" . $details['account'] . "</td></tr>" . (!isset($_SESSION['clearsdn_cookie']['authenticated']) ? "<tr><td align=\'right\'>" . CLEARSDN_SERVICE_LANG_PASSWORD . ":</td><td><input type=\'password\' name=\'password\' id=\'password\' value=\'\'></td></tr>" : "") . "<tr><td align=\'right\'>" . WEB_LANG_PURCHASE_ORDER . ":</td><td><input type=\'hidden\' name=\'method\' id=\'method\' value=\'' + method + '\'><input type=\'text\' name=\'po\' id=\'po\' value=\'\'></td></tr></table></div>');
	      }
